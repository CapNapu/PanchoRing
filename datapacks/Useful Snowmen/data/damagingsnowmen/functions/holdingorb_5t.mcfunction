...
#
# Frost Runner ### MODIFIED BY CAPNAPU
#
...
#
# Slowness Aura ### REMOVED BY CAPNAPU
#
...
#Snow golems have a passive Regen I if they are standing on snow (layer). ### MODIFIED BY CAPNAPU
execute if block ~ ~ ~ snow run effect give @s fire_resistance 6 0 

#Snow golems have a passive Resistance I if they are in a cold biome. ### MODIFIED BY CAPNAPU
execute if entity @s[predicate=damagingsnowmen:in_cold_biome] run effect give @s resistance 6 0
