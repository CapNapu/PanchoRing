...
attribute @s[nbt={PlayerCreated:0b}] generic.attack_damage base set 15
attribute @s[nbt={PlayerCreated:1b}] generic.attack_damage base set 15
attribute @s[nbt={PlayerCreated:0b}] generic.armor base set 10
attribute @s[nbt={PlayerCreated:1b}] generic.armor base set 10
